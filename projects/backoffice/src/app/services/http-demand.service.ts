...
import {BaseHttpService} from "../../../../../src/app/auth/base-http.service";
import {HttpResponseModel} from "../../../../../src/models/http-response.model";
...
export class HttpDemandService extends BaseHttpService {
  ...
  getDemandFull(
    ...
    return this.http.get<HttpResponseModel<DemandModel[]>>(
      `${this.API_USERS_URL}/autorisation/depotage/soumis`,
      {
  ...
  acceptDemand(submitDemand: SubmitDemandModel): Observable<HttpResponseModel<DemandModel>> {
    return this.http.post<HttpResponseModel<DemandModel>>(
      `${this.API_USERS_URL}/autorisation/depotage/accepterdemande
`,
      submitDemand,
      {
        headers: this.httpHeader(),
