import {Component, input, Input, signal, TemplateRef, WritableSignal} from '@angular/core';
import {ButtonDirective, FormControlDirective, FormSelectDirective, TableModule} from "@coreui/angular";
...
export class CustomDataTableComponent<TData, TValue> {
  ...
  customFilter = input<TemplateRef<any> | null>();
